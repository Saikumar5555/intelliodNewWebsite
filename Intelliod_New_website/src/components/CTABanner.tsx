      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/90 text-[17px] lg:text-[19px] mb-10 max-w-[600px] mx-auto leading-relaxed font-medium">
            ...
            <div className="flex flex-wrap justify-center gap-5">
              ...
              <button
                onClick={scrollToTop}
                id="cta-banner-top"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/10 hover:bg-white/20 border border-white/30 text-white text-[15px] font-medium rounded-full transition-all hover:-translate-y-0.5 backdrop-blur-sm"
              >

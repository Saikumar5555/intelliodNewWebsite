...
const Hero = () => {
  ...
  return (
    <section 
      id="home" 
      className="min-h-[92vh] flex flex-col justify-center overflow-hidden" 
      style={{ backgroundImage: 'linear-gradient(180deg, #68BEFC 0%, #FFFFFF 100%)' }}
    >
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-2">
              ...
              >
                Build the Future with Autonomous
              </motion.h1>
              <motion.h1 
                variants={itemVariants}
                className="text-5xl lg:text-6xl font-black leading-tight gradient-text-blue-purple inline-block w-fit"
              >
                AI Agents
              </motion.h1>
            </div>
          ...
          <div className="relative flex flex-col gap-4 lg:gap-6 pt-8 lg:pt-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
              ...
              <div className="relative h-64 w-full group cursor-default">
                <div className="absolute inset-0 rounded-[2rem] rounded-tl-[16rem] rounded-tr-[2rem] overflow-hidden shadow-xl bg-white border border-white/20 transition-transform duration-500 hover:scale-[1.02]">
                  <img
                    src="/images/Hero.jpg"
                ...
                <div className="absolute -top-4 left-[30%] w-16 h-16 bg-[#0a0a0a] rounded-full flex items-center justify-center shadow-2xl z-20 group-hover:bg-gray-900 transition-colors">
              ...
              {/* Stat Card */}
              <div className="bg-white rounded-[2.5rem] p-8 shadow-xl flex flex-col justify-between h-64 border border-gray-50 hover:shadow-2xl transition-all duration-500 group">
                <div>
                  <div className="flex items-baseline gap-1">
                    <Counter value={10} />
                    <span className="text-5xl font-black text-gray-900 tracking-tighter leading-none">M+</span>
                  </div>
                  <div className="mt-4 space-y-0.5">
                    <p className="text-base font-bold">
                      <span className="gradient-text-blue-purple inline-block">AI interactions</span> <span className="text-gray-600 font-medium">handled</span>
                    </p>
                    <p className="text-base font-medium text-gray-600">across platforms</p>
                  </div>
                </div>
                {/* Progress bar */}
            ...
            {/* Chart Card */}
            <div className="bg-white rounded-[2.5rem] p-8 shadow-xl relative overflow-hidden flex flex-col mt-4 min-h-[240px] border border-gray-50 hover:shadow-2xl transition-all duration-500">
              <div className="space-y-3">
                <p className="text-base font-medium text-gray-500">Drive More Traffic and Sales</p>
                <h3 className="text-4xl font-extrabold text-gray-900 leading-[1.1] tracking-tight">
        ...
        <motion.div 
          ...
          className="mt-16 bg-white rounded-2xl border border-gray-100 flex flex-wrap items-center justify-between p-4 px-6 shadow-sm hover:shadow-md transition-shadow"
        >
...
const Counter = ({ value }: { value: number }) => {
  ...
  return <span ref={ref} className="text-5xl font-black text-gray-900 tracking-tighter leading-none">{count}</span>;
};

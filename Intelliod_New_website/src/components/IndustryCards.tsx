...
const BlueFeature = ({ text, icon }: { text: string; icon: React.ReactNode }) => (
  <li className="flex items-center gap-3.5 mb-4 last:mb-0">
    ...
    <span className="text-[14px] sm:text-[15px] font-medium text-[#4B5563]">{text}</span>
  </li>
);
    ...
    <section className="bg-gradient-to-b from-white via-white to-[#EEFDF4] pt-12 lg:pt-16 pb-20 lg:pb-24">
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14 lg:mb-16">
          ...
          <h2 className="text-[36px] lg:text-[48px] font-black text-[#111827] leading-tight tracking-tight">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-10 max-w-5xl mx-auto">
          ...
          <div className="rounded-[2.5rem] overflow-hidden border border-[#E5E7EB] flex flex-col bg-white shadow-sm">
            ...
            <div className="px-8 py-10 lg:px-10 lg:py-10 flex-1 flex flex-col items-start bg-white">
              <h3 className="text-[26px] font-black text-[#111827] mb-2 leading-tight">
                Aadya <span className="font-bold text-[#4B5563] text-xl">– Private GPT</span>
              </h3>
              <p className="text-[#6B7280] text-[15px] font-medium mb-8 leading-relaxed">
              ...
              <button className="bg-[#292929] hover:bg-black text-white text-[15px] font-bold py-3.5 px-8 rounded-full transition-all inline-flex items-center gap-2 mt-auto self-center lg:self-center w-fit">
          ...
          <div className="rounded-[2.5rem] overflow-hidden border border-[#E5E7EB] flex flex-col bg-white shadow-sm">
            ...
            <div className="px-8 py-10 lg:px-10 lg:py-10 flex-1 flex flex-col items-start bg-white">
              <h3 className="text-[26px] font-black text-[#111827] mb-2 leading-tight">
                Neural Farms <span className="font-bold text-[#4B5563] text-xl">– Agrintelligence</span>
              </h3>
              <p className="text-[#6B7280] text-[15px] font-medium mb-8 leading-relaxed">
